...
import mongoose from "mongoose";
  ...
  interface AllUsersProgressTypes{
    _id:string,
    name:string,
    email:string,
    progress:number
  ...
  export const allUsersProgress = async (req:Request, res:Response):Promise<Response | void> => {
    try {
      ...
      const userProgressData:AllUsersProgressTypes[] = users.map((user) => {
 ...
 * @access Admin only
 */
export const totalProgressOfUsers = async (req:Request, res:Response) => {
  try {
    const { id } = req.params;
